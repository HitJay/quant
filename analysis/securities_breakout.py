...
================================================================
背景：
    2026-06-22 证券ETF (512880) 单日 +7.71%，量比 2.16
    2026-06-25 再次盘中 +3.60%（成交31.6亿、换手5.58%）
    全市场最强一日：长江证券单只主力净流入 36.65亿，非银金融 +2.33%
    券商行情看似启动。
...
# 今日盘中数据（实测自 ak.fund_etf_spot_em）
TODAY_CHG = 0.0360       # +3.60%
TODAY_AMOUNT_YI = 31.60   # 31.6亿
TODAY_TURNOVER = 5.58     # 5.58%
TODAY_LJZQ_INFLOW_YI = 36.65  # 长江证券主力净流入36.65亿
TODAY_SECTOR_GAIN = 0.0233   # 非银金融 +2.33%
