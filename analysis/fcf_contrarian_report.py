...
for code, name, brand in [
    ("563390", "全指现金流ETF华泰柏瑞", "华泰柏瑞"),
    ("159201", "自由现金流ETF华夏", "华夏"),
    ("159222", "自由现金流ETF易方达", "易方达"),
    ("159221", "现金流ETF嘉实", "嘉实"),
    ("159223", "现金流ETF永赢", "永赢"),
]:
    sym_key = {"563390": "sh563390", "159201": "sz159201", "159222": "sz159222",
               "159221": "sz159221", "159223": "sz159223"}[code]
...
story.append(Paragraph(
    ...
    "汽车 + 石油石化 + 家电 + 航运 + 钢铁 + 有色是主要风险暴露, 更像偏周期/价值组合。",
    BULLET
))
story.append(Paragraph(
...
events_data = [
    ...
    ["2025-02-27", "华夏 159201 上市", "5400"],
    ["2025-04-17", "易方达 159222 上市", "5700"],
    ["2025-04-30", "华泰柏瑞 563390 上市", "5600"],
    ["2025-05-13", "嘉实 159221 上市", "5500"],
    ["2025-07-03", "永赢 159223 上市", "5600"],
...
et.setStyle(TableStyle([
    ...
    ("BACKGROUND", (0, 8), (-1, 8), colors.HexColor("#fee2e2")),
]))
story.append(et)
story.append(Spacer(1, 0.3 * cm))
...
story.append(Paragraph(
    ...
    "把前 10 持仓按行业聚合, 看你想买的到底是周期/价值/红利低波还是其他主题。",
    BULLET))
story.append(Paragraph(
    "<b>③ 对比规模与流动性。</b> 华夏 159201 + 易方达 159222 持仓高度接近, "
    "选规模大的那只 (流动性好, 折溢价小)。",
    BULLET))
