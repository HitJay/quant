...
story += [
    ...
    Paragraph(
        "512880 · 2026-06-22 +7.71% → 2026-06-25 +3.42%<br/>"
...
story += [
    ...
    Paragraph(
        ...
        '6/25 再放量 +3.42%，四日累计涨幅约 +9.2%（中间 6/23 平、6/24 -1.77% 回踩）。'
...
story += [
    ...
    Paragraph(
        "2026-06-25 盘后，非银金融板块整体跟涨：长江证券 (000783) 单日主力净流入 4.03 亿（6/23 那天才是真吸金 +7.49 亿，6/24 又流出 -6.99 亿），"
        "证券Ⅱ +3.05%、保险Ⅱ +3.56%；证券ETF 收盘 +3.42%，成交 41.92 亿，换手率 7.49%。"
        "这是继 6/22 单日大涨 +7.71% 后，经 6/23 平、6/24 -1.77% 回踩，于 6/25 的二次冲击，四日累计涨幅约 +9.2%。", S["body"]),
    Paragraph(
...
story += [
    ...
    Paragraph(f'&nbsp;&nbsp;• MA20 = {MA20:.3f}，MA60 = {MA60:.3f}，价格站上 MA60 但距前高仍有 13%+ 空间', S["body"]),
    Paragraph('&nbsp;&nbsp;• 属于"中位反弹区"，既非历史底部，也非新高启动', S["body"]),
    Paragraph("7.2 资金结构", S["h3"]),
    Paragraph('&nbsp;&nbsp;• 6/25 长江证券主力净流入 <b>4.03 亿</b>（6/23 单日 +7.49 亿、6/24 -6.99 亿，4 日累计净流入约 -1.3 亿）— 主力资金未持续加仓，散户接力特征明显', S["body"]),
    ...
    Paragraph('&nbsp;&nbsp;3. <b>情绪风险</b>：四日 +9.2% 后，散户 FOMO 入场风险加大', S["body"]),
